...
type AggregatorClient interface {
	AggregateInvoice(ctx context.Context, in *AggregateRequest, opts ...grpc.CallOption) (*AggregateReply, error)
}
...
func (c *aggregatorClient) AggregateInvoice(ctx context.Context, in *AggregateRequest, opts ...grpc.CallOption) (*AggregateReply, error) {
	out := new(AggregateReply)
	err := c.cc.Invoke(ctx, "/proto.Aggregator/AggregateInvoice", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AggregatorServer interface {
	AggregateInvoice(context.Context, *AggregateRequest) (*AggregateReply, error)
...
func (UnimplementedAggregatorServer) AggregateInvoice(context.Context, *AggregateRequest) (*AggregateReply, error) {
...
func _Aggregator_AggregateInvoice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AggregateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AggregatorServer).AggregateInvoice(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Aggregator/AggregateInvoice",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AggregatorServer).AggregateInvoice(ctx, req.(*AggregateRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Aggregator_AggregateInvoice_Handler,
		},
	},
